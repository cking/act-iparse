...
exports.list = [
  {
    name: 'polo',
    date: 'To Be Done',
    changes: ['direct hit and crit direct hit support', 'completely changed and revamped rendering engine']
  },
  {
    name: 'transfusion',
    date: '2017-06-27',
    changes: ['stormblood support', 'long standing colorization issues']
  },
  {
    name: 'ladybug',
    date: '2017-03-03',
  ...
  },
  {
    name: 'inkognito',
    date: '2017-02-23',
    changes: ['Gave ROG a color', 'Limit break now in color', 'Transparency for meter is now a thing']
  },
  {
    name: 'bacon',
    date: '2017-02-19',
